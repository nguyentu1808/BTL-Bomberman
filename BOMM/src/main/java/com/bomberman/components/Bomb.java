...
public class Bomb extends Component {
    ...
    public Bomb() {
        onCollisionEnd(Type_Game.BOMB, Type_Game.PLAYER, (b, p) -> {
            if (entity != null) {
    ...
    public void getRightBlocks() {
        List<Entity> temp = new ArrayList<>(getGameWorld().getEntitiesByType(Type_Game.WALL));
        ...
        List<Entity> temp1 = new ArrayList<>(getGameWorld().getEntitiesByType(Type_Game.BRICK));
        ...
        List<Entity> temp2 = new ArrayList<>(getGameWorld().getEntitiesByType(Type_Game.CORAL));
        ...
        List<Entity> temp3 = new ArrayList<>(getGameWorld().getEntitiesByType(Type_Game.GRASS));
